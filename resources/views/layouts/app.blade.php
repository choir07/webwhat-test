        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="space-x-4">
                    ...
                    <a href="/admin" class="text-gray-600 hover:text-gray-800">Admin</a>                <button onclick="toggleTheme()" class="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white ml-4">
                    <span class="dark:hidden">ðŸŒ™ Dark</span>
